...
主账号先后因破坏被封禁或部分封禁4次。最后一次是2023年11月6日被封禁3个月 （不能编辑自己的讨论页），理由是「过多破坏行为：冒用他人信息，在编辑简介中广告宣传，继续添加无意义内容」。

其后，使用恶意程序，通过小号批量创建无意义页面（总数达到几百条），干扰锑星百科正常运行。随后锑星百科将其封禁改为永久封禁（包括其小号）。[封禁日志](https://antimony.fandom.com/zh/wiki/Special:Log/block?page=User:Gongxiang01)
